...
echo 28bceaceeb6055fada11cf3ba1dcc3ffec4997925dee096a736fdaef4d370e56  $OCAMLLSP.tar.gz | sha256sum -c -
echo 05ee153f176fbf077166fe637136fc679edd64a0942b8a74e8ac77878ac25d3f  $OCAMLFORMAT.tar.gz | sha256sum -c -
