...
cp ocamlformat.0.27.0-built-with-ocaml.5.3.1+relocatable.tar.gz "$ORIGINAL_DIR/ocamlformat-aarch64-macos.0.27.0-built-with-ocaml.5.3.1+relocatable.tar.gz"
