...
RUN tar czf ocamlformat-x86_64-linux-gnu.0.27.0-built-with-ocaml.5.3.1+relocatable.tar.gz ocamlformat.0.27.0-built-with-ocaml.5.3.1+relocatable

FROM scratch
COPY --from=builder /home/user/ocamlformat/ocamlformat-x86_64-linux-gnu.0.27.0-built-with-ocaml.5.3.1+relocatable.tar.gz .
