...
let aarch64_macos_5_3_1 =
  ...
  ; ocamllsp =
      rt
        ...
        ~top_level_dir:"ocamllsp-1.22.0-built-with-ocaml-5.3.1+relocatable-aarch64-macos"
...
let x86_64_macos_5_3_1 =
  ...
  ; ocamllsp =
      rt
        ...
        ~version:"1.22.0"
        ~url_base:url_base_5_3_1
        ~url_file:"ocamllsp-1.22.0-built-with-ocaml-5.3.1+relocatable-x86_64-macos.tar.gz"
...
let x86_64_windows_5_3_1 =
  ...
  ; ocamllsp =
      rt
        ...
        ~top_level_dir:"ocamllsp-1.22.0-built-with-ocaml-5.3.1+relocatable-x86_64-windows"
